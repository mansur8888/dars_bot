...
class DarsTaqsimot(StatesGroup):
    ...
    total_hours = State()
    teacher_count = State()
    teacher_name = State()   # O'qituvchi F.I.Sh. kiritish
    teachers_data = State()

# Fanlar ro'yxati
SUBJECTS_YUQORI = [
    "O'zbek tili / Ona tili", "Adabiyot", "Matematika (Algebra/Geometriya)", 
    "Chet tili (Ingliz/Olmon/Fransuz)", "Tarix / Huquq", "Fizika", "Kimyo", 
    "Biologiya", "Geografiya", "Informatika", "Jismoniy tarbiya", 
    "Texnologiya", "Tasviriy san'at / Musiqa", "CHBT (CHYOT)"
]

SUBJECTS_BOSHLANGICH = [
    "Boshlang'ich ta'lim (O'qish/Yozuv/Matematika)", "Chet tili (Boshlang'ich)", 
    "Jismoniy tarbiya (1-4 sinf)", "Musiqa / Tasviriy san'at", "Texnologiya"
]
